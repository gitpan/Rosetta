...
branch, and v3.0.3 is the current beta branch, which will move into production
...
PostgreSQL 7.4.3 databases, with 7.3.6 support likely present but deprecated. 
