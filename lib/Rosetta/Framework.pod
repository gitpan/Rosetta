...
This distribution is getting split up soon.  When that happens, the "Rosetta" 
distribution will be dependant on the new "SQL-SyntaxModel" distribution.
...
categories, which can be called: "Locale", "Schema" (SQL::SyntaxModel),
"Engine", "Driver", "Proxy" (Server/Client), "Validator", "Emulator", and
others.
...
"Engine" modules being mostly reduced to struct definitions, macros for
...
modules, particularly the "Driver", "Proxy", "Validator", "Emulator" ones.  The
...
To become "SQL-SyntaxModel" or similar:
	...
	SQL::SyntaxModel::L::en (English localization of input error messages)
	SQL::SyntaxModel::L::fr (French localization of input error messages)
	SQL::SyntaxModel::L::* ... like German, Spanish, Dutch, Chinese, etc

	SQL::SyntaxModel::DataDictionary (POD only, describes a db suitable for storing SQL::SyntaxModels)
	SQL::SyntaxModel::XMLSchema (POD only, describes an XML schema suitable for storing SQL::SyntaxModels)
	SQL::SyntaxModel::API_C (POD only, describes the core C API for SQL::SyntaxModel)
...
To become "SQL-SyntaxModel-ByTree" or similar:
	...
	SQL::SyntaxModel::ByTree::L::en (English localization of input error messages)

To become "SQL-SyntaxModel-SkipID" or similar:

	SQL::SyntaxModel::SkipID (Use SQL::SyntaxModels without inputting Node IDs)
	SQL::SyntaxModel::SkipID::L::en (English localization of input error messages)
...
To stay "Rosetta":
	...
	Rosetta::L::en (English localization of execution/input error messages)
	Rosetta::L::fr (French localization of execution/input error messages)
...
"http://freshmeat.net/articles/view/305/" and "http://freshmeat.net/articles/view/307/">
	...
	Rosetta::Driver::SQLite (binding to public domain SQLite embedded db; default RDBMS for Rosetta)
	Rosetta::Driver::Oracle (interface to Oracle db 8, 9)
	Rosetta::Driver::Sybase (interface to Sybase db)
	Rosetta::Driver::PostgreSQL (interface to PostgreSQL db 7.4.x, 7.3.x)
	Rosetta::Driver::MySQL (interface/binding to MySQL cli-serv/embed db 4.x, 5.x, 3.23.x)
...
=head2 Schema (SQL::SyntaxModel) Modules

=over 4

=item 0

B<SQL::SyntaxModel::_::Command> - This Schema class describes an action that needs
...
Rosetta::Engine::_::Command.>

=item 0

B<SQL::SyntaxModel::_::DataType> - This Schema class describes a simple data type,
...
B<SQL::SyntaxModel::_::Table> - This Schema class describes a single database
...
B<SQL::SyntaxModel::_::View> - This Schema class describes a single database view,
...
B<Rosetta::_::Engine> - This Engine class is inherited by all other Engine
...
B<Rosetta::_::Command> - This Engine class describes an action that needs
...
B<Rosetta::_::Result> - This Engine class is inherited by all Engine
...
B<Rosetta::_::Connection> - This Engine class represents a connection
...
B<Rosetta::_::Cursor> - This Engine class represents a cursor over a
...
B<Rosetta::Driver::SQLite> - This class embeds the public domain SQLite RDBMS,
and will serve as a default (though separately distributed) driver for Rosetta.
...
subselects.  This driver is intended mainly for programs that are used by one
person at a time, as locks will grab the whole database.
...
B<Rosetta::Driver::PostgreSQL> - This class implements a driver for talking to 
PostgreSQL 7.4 and 7.3 databases, with 7.4 being strongly recommended.  Support 
for 7.3 will probably be deprecated, or moved to a separate driver if there is 
a long-term demand.  Versions 7.2 and earlier won't be supported without demand.

=item 0

B<Rosetta::Driver::MySQL> - This class implements a driver for talking to MySQL
databases.  It is intended to be used only with MySQL versions 4.0.17 and
...
perl(1), Rosetta, Rosetta::SimilarModules, SQL::SyntaxModel,
SQL::SyntaxModel::DataDictionary, SQL::SyntaxModel::XMLSchema,
SQL::SyntaxModel::API_C, DBI.
