...
supported or not is not applicable.  That said, v2.8.14 is the current stable
branch, and v3.0.2 is the current beta branch, which will move into production
