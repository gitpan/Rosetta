...
main versions, v3.2.1 and v2.8.16 (both of which are declared stable); the 2.x
support is deprecated.

=item

B<Rosetta::Engine::MySQL> - This class implements an Engine for talking to MySQL
databases.  It is recommended for use only with MySQL versions 5.0.4 (beta) and
greater.  Support for MySQL versions 4.1.11 and 4.0.24 and 3.23.58 (all 3
...
OpenBase 8.0.4 databases.  v7.x and earlier won't be supported without demand.
