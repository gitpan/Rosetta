...
transition, mainly in the 'Extensions' arena.  See below for details.  Most of
...
split them up such as is seen in the other module blocks, below.
	...
	Rosetta::Extensions (a small place-holder POD file to represent the distribution on CPAN)
