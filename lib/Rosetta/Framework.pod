...
main versions, v3.2.0 and v2.8.16 (both of which are declared stable); the 2.x
support is deprecated.

=item

B<Rosetta::Engine::MySQL> - This class implements an Engine for talking to
MySQL databases.  It is recommended for use only with MySQL versions 4.1.10a
(stable) and greater, including v5.0.2 (alpha) and v5.1.x.  Support for MySQL
versions 4.0.24 (stable) and 3.23.58 (stable) is present but deprecated. 
...
8.0.1 (stable) and greater.  Support for PostgreSQL versions 7.4.7 and 7.3.9 and
7.2.7 is present but deprecated.  v7.1.x and earlier will not be supported at
