...
8.0.2 (stable) and greater.  Support for PostgreSQL versions 7.4.7 and 7.3.9 and
7.2.7 (all 3 stable) is present but deprecated.  v7.1.x and earlier will not be
supported at all, without great demand.
