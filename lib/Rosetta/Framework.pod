...
During the short term, these following 4 modules will have their first
...
split them up such as is seen in the other module blocks, below.
	...
	Rosetta::Utility::SQLParser (parse ANSI/ISO SQL-1999 and other SQL variants)
...
PostgreSQL 7.4.2 databases, with 7.3.6 support likely present but deprecated. 
