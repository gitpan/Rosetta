...
Note: see also the SQL::SyntaxModel library, which is the foundation for the
...
The C version of Rosetta will probably have the "Model" (SQL::SyntaxModel) and
...
=head2 In distribution "SQL-SyntaxModel"
...
"http://freshmeat.net/articles/view/305/" and "http://freshmeat.net/articles/view/307/">
	...
	Rosetta::Engine::PostgreSQL (interface to PostgreSQL db 8.0.x, 7.4.x, 7.3.x)
...
=head2 In historical posterity distribution "SQL-SyntaxModel-ByTree"
...
=head2 In historical posterity distribution "SQL-SyntaxModel-SkipID"
...
SQL::SyntaxModel::Command objects and also encapsulates the resolved host params,
...
embed both main versions, v2.8.15 and v3.0.6, with the 2.x support deprecated.
...
PostgreSQL databases.  It is intended to be used only with PostgreSQL versions
7.4.5 and later, with version 8.0.0 or greater being strongly recommended. That
said, which version you should use depends on your stage of development.
PostgreSQL 8.0.0 reached 2nd-beta on 2004.09.08, while the officially
stable 7.4.5 was released on 2004.08.23.  Support for 7.3.x in this module will
be present in the short term, but it is deprecated.  7.2.x and earlier will not
be supported at all, without great demand.

=item

B<Rosetta::Engine::MySQL> - This class implements an Engine for talking to
MySQL databases.  It is intended to be used only with MySQL versions 4.0.21 and
later, with version 4.1.4 or greater being strongly recommended; you can also
consider 5.0.1 or greater.  That said, which version you should use depends on
your stage of development.  MySQL AB had declared the 4.0.x series to be
production quality at v4.0.12 (2003.03.15), and since then this line had over a
year's worth of bug-fix improvements.  MySQL AB had declared the 4.1.x series
to be gamma quality at v4.1.4 (2004.08.26), and previously was at beta quality
at v4.1.3 (2004.06.28), and previously was at alpha quality at v4.1.0
(2003.04.10); they initially said the 4.1.x line would be production ready 8
months after its alpha release.  MySQL AB provided a preview release of the
5.0.x line on 2003.12.22, which is v5.0.0; at the same time that the 4.1.x line
was declared beta, the 5.0.x line was declared alpha, without a version
increment; they initially said 5.0.x would be production ready 6 months after
4.1.x was.  Support for 3.23.x in this module will be present in the short term,
but it is deprecated.  3.22.x and earlier will not be supported at all, without
great demand.
