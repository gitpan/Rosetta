...
categories, which can be called: "Schema", "Engine", "Driver", "Locale",
"Emulator", and others.
...
written.  Not all modules are listed.  If details for a module have been written 
and don't appear here, then that module was implemented in code already, and it 
is in its own file with complete POD therein.  This documentation section is 
temporary and its contents will be moved to other files.
