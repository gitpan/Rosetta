...
MySQL databases.  It is recommended for use only with MySQL versions 4.1.8
(stable) and greater, including v5.0.2 (alpha) and v5.1.x.  Support for MySQL
versions 4.0.22 (stable) and 3.23.58 (stable) is present but deprecated. 
...
8.0.0rc1 and greater.  Support for PostgreSQL versions 7.4.6 and 7.3.8 and 7.2.6
