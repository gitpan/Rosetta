...
=head1 CONTENT OF rosetta_schema_datatype.h
	...
	} en_rose_sch_datatype_base; /* enumeration of basic data types */

	typedef enum { 
		PRESERVE, /* preserve existing case, upper and lower */
		TOUPPER,  /* convert to upper case */
		TOLOWER   /* convert to lower case */
	} en_rose_sch_datatype_case; /* enumeration of ways to handle latin character data */
	...
	} st_rose_sch_datatype; /* meta-data for a scalar unit of data, such as a db table column */
