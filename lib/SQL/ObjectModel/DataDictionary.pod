...
All concepts in a SQL::ObjectModel can be represented by a
...
will attempt to explain the components of a SQL::ObjectModel data dictionary and how
they relate.  Since SQL::ObjectModel doesn't actually use any database tables
internally, and that it is your application which would map such database
tables to SQL::ObjectModel objects, you are free to modify this schema to your liking. 
