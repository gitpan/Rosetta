...
my %text_strings = (
	'SSM_S_CR_EMP_NODE_NO_ARGS' => 
		"create_empty_node(): missing NODE_TYPE argument",
	'SSM_S_CR_EMP_NODE_BAD_TYPE' => 
...
The SQL::SyntaxModel::L::en Perl 5 object class contains localization data for
