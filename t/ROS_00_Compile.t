...
is( $Rosetta::Model::VERSION, qv('0.723.0'),
...
is( $Rosetta::Validator::VERSION, qv('0.723.0'),
...
is( $Rosetta::Engine::Example::VERSION, qv('0.723.0'),
...
is( $Rosetta::Shell::VERSION, qv('0.1.1'),
