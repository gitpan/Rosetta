...
t_ROS_Util->message( 'Test model construction using terse wrapper interface.' );
...
eval {
    ...
    my $expected_output = t_ROS_Terse->expected_model_nid_xml_output();
    ...
    my $expected_output2 = t_ROS_Terse->expected_model_sid_long_xml_output();
    ...
    my $expected_output3 = t_ROS_Terse->expected_model_sid_short_xml_output();
