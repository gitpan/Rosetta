...
# `make test'. After `make install' it should work as `perl Rosetta-Schema-Table.t'
...
message( "START TESTING Rosetta::Schema::Table" );
...

{
	...
	my $rst1 = Rosetta::Schema::Table->new();  
	result( UNIVERSAL::isa( $rst1, "Rosetta::Schema::Table" ), 
...
message( "DONE TESTING Rosetta::Schema::Table" );
