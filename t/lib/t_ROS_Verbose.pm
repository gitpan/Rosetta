...
# This module is used when testing Rosetta::Model.
...
# Rosetta::Model, and possibly other modules that are derived from it.
...
sub populate_model {
    ...
    $rte_install_a1->set_attribute( 'cont_type', 'ROS_M_NODE' );
    ...
    $rte_remove_a1->set_attribute( 'cont_type', 'ROS_M_NODE' );
    ...
    $rte_select_defn->set_attribute( 'cont_type', 'ROS_M_NODE' );
    ...
    $rte_insert_defn->set_attribute( 'cont_type', 'ROS_M_NODE' );
    ...
    $rte_update_defn->set_attribute( 'cont_type', 'ROS_M_NODE' );
    ...
    $rte_delete_defn->set_attribute( 'cont_type', 'ROS_M_NODE' );
        ...
        <application id="23" si_name="Setup">
            ...
            <routine id="25" si_name="install_app_schema" routine_type="PROCEDURE">
                <routine_stmt id="26" call_sroutine="CATALOG_CREATE">
                    <routine_expr id="27" call_sroutine_arg="LINK_BP" cont_type="ROS_M_NODE" act_on="24" />
            ...
            <routine id="29" si_name="remove_app_schema" routine_type="PROCEDURE">
                <routine_stmt id="30" call_sroutine="CATALOG_DELETE">
                    <routine_expr id="31" call_sroutine_arg="LINK_BP" cont_type="ROS_M_NODE" act_on="24" />
                </routine_stmt>
            </routine>
        </application>
        <application id="32" si_name="People Watcher">
            ...
            <routine id="50" si_name="fetch_all_persons" routine_type="FUNCTION" return_cont_type="RW_ARY" return_row_data_type="13">
                ...
                <routine_stmt id="53" call_sroutine="SELECT">
                    ...
                    <routine_expr id="57" call_sroutine_arg="SELECT_DEFN" cont_type="ROS_M_NODE" act_on="54" />
            ...
            <routine id="61" si_name="insert_a_person" routine_type="PROCEDURE">
                ...
                <routine_stmt id="64" call_sroutine="INSERT">
                    ...
                    <routine_expr id="68" call_sroutine_arg="INSERT_DEFN" cont_type="ROS_M_NODE" act_on="65" />
                </routine_stmt>
            </routine>
            <routine id="69" si_name="update_a_person" routine_type="PROCEDURE">
                ...
                <routine_stmt id="75" call_sroutine="UPDATE">
                    ...
                    <routine_expr id="89" call_sroutine_arg="UPDATE_DEFN" cont_type="ROS_M_NODE" act_on="76" />
                </routine_stmt>
            </routine>
            <routine id="90" si_name="delete_a_person" routine_type="PROCEDURE">
                ...
                <routine_stmt id="93" call_sroutine="DELETE">
                    ...
                    <routine_expr id="101" call_sroutine_arg="DELETE_DEFN" cont_type="ROS_M_NODE" act_on="94" />
                </routine_stmt>
            </routine>
        </application>
    </blueprints>
...
<root>
    ...
    <blueprints>
        ...
        <application id="23" si_name="Setup">
            ...
            <routine id="25" si_name="install_app_schema" routine_type="PROCEDURE">
                <routine_stmt id="26" call_sroutine="CATALOG_CREATE">
                    <routine_expr id="27" call_sroutine_arg="LINK_BP" cont_type="ROS_M_NODE" act_on="admin_link" />
                    <routine_expr id="28" call_sroutine_arg="RECURSIVE" cont_type="SCALAR" valf_literal="1" scalar_data_type="boolean" />
                </routine_stmt>
            </routine>
            <routine id="29" si_name="remove_app_schema" routine_type="PROCEDURE">
                <routine_stmt id="30" call_sroutine="CATALOG_DELETE">
                    <routine_expr id="31" call_sroutine_arg="LINK_BP" cont_type="ROS_M_NODE" act_on="admin_link" />
                </routine_stmt>
            </routine>
        </application>
        <application id="32" si_name="People Watcher">
            ...
            <routine id="50" si_name="fetch_all_persons" routine_type="FUNCTION" return_cont_type="RW_ARY" return_row_data_type="[person_type,gene,The Catalog Blueprint]">
                ...
                <routine_stmt id="53" call_sroutine="SELECT">
                    ...
                    <routine_expr id="57" call_sroutine_arg="SELECT_DEFN" cont_type="ROS_M_NODE" act_on="fetch_all_persons" />
            ...
            <routine id="61" si_name="insert_a_person" routine_type="PROCEDURE">
                ...
                <routine_stmt id="64" call_sroutine="INSERT">
                    ...
                    <routine_expr id="68" call_sroutine_arg="INSERT_DEFN" cont_type="ROS_M_NODE" act_on="insert_a_person" />
                </routine_stmt>
            </routine>
            <routine id="69" si_name="update_a_person" routine_type="PROCEDURE">
                ...
                <routine_stmt id="75" call_sroutine="UPDATE">
                    ...
                    <routine_expr id="89" call_sroutine_arg="UPDATE_DEFN" cont_type="ROS_M_NODE" act_on="update_a_person" />
                </routine_stmt>
            </routine>
            <routine id="90" si_name="delete_a_person" routine_type="PROCEDURE">
                ...
                <routine_stmt id="93" call_sroutine="DELETE">
                    ...
                    <routine_expr id="101" call_sroutine_arg="DELETE_DEFN" cont_type="ROS_M_NODE" act_on="delete_a_person" />
                </routine_stmt>
            </routine>
        </application>
    </blueprints>
