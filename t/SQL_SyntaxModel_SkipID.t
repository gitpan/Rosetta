...
use SQL::SyntaxModel::SkipID 0.12;
use SQL::SyntaxModel::SkipID::L::en 0.03;
$loaded = 1;
print "ok 1\n";
use strict;
use warnings;
...
message( "START TESTING SQL::SyntaxModel::SkipID Sibling Compatibility (SSMBTR)" );
...
message( "DONE TESTING SQL::SyntaxModel::SkipID Sibling Compatibility (SSMBTR)" );
